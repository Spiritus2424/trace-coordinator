...
lttng -g gigl create ${Hosts} --output=/home/tmp/tracing/${1}-${Hosts}
lttng -g gigl enable-event --session=${Hosts} -k sched_switch,sched_waking,sched_pi_setprio,sched_process_fork,sched_process_exit,sched_process_free,sched_wakeup,\
